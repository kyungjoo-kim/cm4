...
% operators using the optimized-based coupling method.
%
% [errN,errL] = run_coupling_optimize(NN, NL, epsilon,test)
% * Input
...
%
% * Note that this version uses finite different to compute
